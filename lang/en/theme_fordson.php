...
$string['region-fp-full'] = 'Column Full Width';
...
$string['contentbuttonextraone'] = 'Extra button 1';
$string['contentbuttonextraone_desc'] = 'Enter the name of the extra button 1';
$string['contentbuttonextraoneurl'] = 'Extra button 1 URL';
$string['contentbuttonextraoneurl_desc'] = 'Enter URL of the extra button 1. <br> Example: https://lms.ou.edu.vn/thi202';

$string['contentbuttonextratwo'] = 'Extra button 2';
$string['contentbuttonextratwo_desc'] = 'Enter the name of the extra button 2';
$string['contentbuttonextratwourl'] = 'Extra button 2 URL';
$string['contentbuttonextratwourl_desc'] = 'Enter URL of the extra button 2. <br> Example: https://lms.ou.edu.vn/thi202';

$string['contentbuttonextrathree'] = 'Extra button 3';
$string['contentbuttonextrathree_desc'] = 'Enter the name of the extra button 3 ';
$string['contentbuttonextrathreeurl'] = 'Extra button 3 URL';
$string['contentbuttonextrathreeurl_desc'] = 'Enter URL of the extra button 3. <br> Example: https://lms.ou.edu.vn/thi202';

$string['technicalsupportmobile'] = 'Technical support phone number';
$string['technicalsupportmobile_desc'] = 'Enter phone number of the technical support(text) <br> Example: 1800 599 953 - nhánh số 2';
$string['technicalsupportemail'] = 'Technical support email';
$string['technicalsupportemail_desc'] = 'Enter email of the technical support(text) <br> Example: kythuat@oude.edu.vn ';
...
$string['phonenumber:footer'] = '18006119 (Ext 2)';
