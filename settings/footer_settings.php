...
// Elo: Duy Select show/hide footer in login design
$name = 'theme_fordson/showfooter';
$title = get_string('showfooter', 'theme_fordson');
$description = get_string('showfooter_desc', 'theme_fordson');
$default = 1;
