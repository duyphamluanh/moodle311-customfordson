...
// // Elo: Duy Select guildelines design
$name = 'theme_fordson/guidelines';
$title = get_string('guidelines', 'theme_fordson');
$description = get_string('guidelines_desc', 'theme_fordson');
$default = 1;
...
$choices = array(
    ...
    '2'=>$coursestyle2,
    '3'=>$coursestyle3,
    //  '4'=>$coursestyle4, '5'=>$coursestyle5, '6'=>$coursestyle6, '7'=>$coursestyle7, '8'=>$coursestyle8, '9'=>$coursestyle9, '10'=>$coursestyle10
);
$setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);
